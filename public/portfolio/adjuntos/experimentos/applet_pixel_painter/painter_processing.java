...
public class painter_processing extends PApplet {
...
public void draw() {
  ...
  if (mousePressed && (mouseButton == LEFT)) {
    ...
    else if(mouseX>=167&&mouseX<=349.998f&&mouseY>=700&&mouseY<=750) {
      b+=5;
    }
    ...
    stroke(255);
    fill(r,g,b);
    println("valor="+PApplet.parseFloat(mouseX)/10);
...
stroke(0,255,0);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "painter_processing" });
  }
}
